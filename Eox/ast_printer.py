...
class AstPrinter(expressions.ExprVisitor):
    ...
    def visit_call_expr(self, expr: expressions.Call) -> str:
        return self.parenthesize('voki', expr.callee, expr.arguments)
